...
EQUIP(RING,			false,	true,	N_("On %s"),		N_(""),				N_("wearing on your %s"))
EQUIP(AMULET,		false,	true,	N_("Around %s"),	N_(""),				N_("wearing around your %s"))
EQUIP(LIGHT,		false,	false,	N_("Light source"),	N_(""),				N_("using to light your way"))
EQUIP(BODY_ARMOR,	true,	true,	N_("On %s"),		N_(""),				N_("wearing on your %s"))
EQUIP(CLOAK,		true,	true,	N_("On %s"),		N_(""),				N_("wearing on your %s"))
EQUIP(SHIELD,		true,	true,	N_("On %s"),		N_(""),				N_("wearing on your %s"))
EQUIP(HAT,			true,	true,	N_("On %s"),		N_(""),				N_("wearing on your %s"))
EQUIP(GLOVES,		true,	true,	N_("On %s"),		N_(""),				N_("wearing on your %s"))
EQUIP(BOOTS,		true,	true,	N_("On %s"),		N_(""),				N_("wearing on your %s"))
