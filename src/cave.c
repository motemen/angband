...
/*
 * 2.7.9v3-v6 ì˙ñ{åÍî≈êªçÏ: ÇµÇ∆ÇµÇÒ
 * 2.8.0      ëŒâû        : sayu, ÇµÇ∆ÇµÇÒ
 * 2.8.1      ëŒâû        : FIRST
 * 2.8.3      ëŒâû        : FIRST, ÇµÇ∆ÇµÇÒ
 * 2.9.0      ëŒâû        : ìÌê£
 */
 ...
 * ÅuÅ°ÅvÇÕìÒî{ïùì§ïÖÇÃì‡ïîÉRÅ[ÉhÇ…égópÅB
 */
...
void display_map(int *cy, int *cx)
{
	...
	if (use_bigtile) /* BUGFIX ; bigtileëŒâû */
	{
#ifdef JP
		Term_putch(col + 2, row + 1, ta2, tc2);
#else /* JP */
...
void do_cmd_view_map(void)
{
	int cy, cx;
#ifdef JP
	cptr prompt = "âΩÇ©ÉLÅ[ÇâüÇ∑Ç∆ÉQÅ[ÉÄÇ…ñﬂÇËÇ‹Ç∑";
#else /* JP */
